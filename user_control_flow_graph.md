...
flowchart TD
  ...
  E --> F[Default Tab Team Builder]
    ...
    subgraph TEAM_BUILDER[Team Builder]
      ...
      TB1 --> TB1A[Resolve Steam ID and Fetch Profile]
      ...
      TB2C --> TB2D[Leetify API and Selenium fallback per player]
      ...
      TB4 --> TB5[Balance algorithm computes CT and T]
    ...
    subgraph STATISTICS_STACK[Statistics Tabs]
      ...
      ST1 --> ST2[Load overview and recent maps]
      ST2 --> ST3[Lazy load cached parsed payloads]
      ST3 --> ST4[Render overview cards and map list]
